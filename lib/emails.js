    ...
    html: `
       <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px">
        ...
        <p style="color:#555;font-size:15px;line-height:1.6">
          Hi ${playerName},<br/><br/>
          <img src="https://babythomaseneline.stevencollet.com/Marcel-edm.jpg" style="max-width: 300px; width: 100%; height: auto; border-radius: 15px;"><br/><br/>
        ...
        <a href="https://babythomaseneline.stevencollet.com/" style="display:inline-block;margin-top:16px;padding:12px 28px;background:#3B6D11;color:#EAF3DE;text-decoration:none;border-radius:8px;font-weight:500;font-size:15px">
          Make your guess
        </a>
        ...
        <p style="color:#000;font-size:12px;margin-top:32px;font-style:italic;">
          Experiencing issues? Contact Steven Collet through the link below.
  ...
  return {
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px">
        ...
        <p style="color:#555;font-size:15px;line-height:1.6">
          Hi ${playerName},<br/><br/>
          Amazing — you guessed Morris' name correctly!<br/>
           <img src="https://babythomaseneline.stevencollet.com/End-img.jpg" style="max-width: 300px; width: 100%; height: auto; border-radius: 15px;">
          <br/><br/>Now keep the secret safe until Morris is born.
        </p>
        <p style="color:#aaa;font-size:12px;margin-top:32px">
          We'll send you an announcement when Morris arrives.
        </p>
        <p style="color:#000;font-size:12px;margin-top:32px;font-style:italic;">
          Experiencing issues? Contact Steven Collet through the link below.
<br/>Created by <a href="https://www.linkedin.com/in/steven-collet/" target="_blank" rel="noopener noreferrer">Steven Collet</a>
